/**
 **  Algoritmo di ordinamento bubble sort senza variabile intermedia
 **
*/
...
for(let posizione=0; posizione<lista.length-1; ++posizione){
  ...
  if(lista[pos_intern]>lista[pos_intern+1]){
    lista[pos_intern] = lista[pos_intern]+lista[pos_intern+1];
    lista[pos_intern+1] = lista[pos_intern]-lista[pos_intern+1];
    lista[pos_intern] = lista[pos_intern]-lista[pos_intern+1];
  }
  }
}
